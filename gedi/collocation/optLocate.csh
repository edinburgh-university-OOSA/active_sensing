...
foreach file( $inList )
  ...
  set output="simplex.$root.txt"

  if( ! -e $output )then
    touch $output 
    collocateWaves -listAls alsList.txt -gedi $file -lEPSG 4326 -aEPSG 32611 -solveCofG -readHDFgedi -output $output -minSense 0.8 -geoError 50 5  -fixFsig
  endif
end
